...
import java.net.URL;
public class AmountInterest10010Test {
  ...
  @Test
  public void amountInterest10010() {
    ...
    assertThat(driver.findElement(By.id("error")).getText(), is("You must agree to the processing !"));
  }
}
