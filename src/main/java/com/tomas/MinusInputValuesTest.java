...
import java.net.URL;
public class MinusInputValuesTest {
  ...
  public void minusInputValues() {
    ...
    assertThat(driver.findElement(By.id("error")).getText(), is("Amount must be a number between 0 and 1000000 !\n" +
